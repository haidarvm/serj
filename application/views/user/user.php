	...
	<section class="content">
		...
		<div class="box box-info" id="quick-user-box">
          ...
          `			<?php if($action=='insert') {?>
						<form action="<?php echo site_url();?>user/register" class="form-horizontal" id="validation-reg" method="post" role="form">
						<?php } else {?>
						<form action="<?php echo site_url();?>user/update/<?php echo !empty($user) ? $user->user_id : "";?>"
