	...
	var dataTable = $('#manus-grid').DataTable( {
			...
			"aoColumnDefs": [{
				...
				mRender: function ( data, type, row ) {
					return '<div class="btn-group"><a href="'+ site_url + 'tlhp/manus/detail/'+ row[0]+'" class="btn btn-primary btn-xs"><i class="fa fa-eye"></i> Detail</a> &nbsp; <a href="#" data-toggle="modal" data-target="#confirm-delete-modal" data-href="'+ site_url + 'tlhp/manus/delete/'+ row[0]+'" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> Delete</a></div>';
				}
			}]
      });
