					...
					<div class="content">
						...
						<div class="row">
							<div class="col-md-7 col-md-offset-2 top-space">
								<form class="form-horizontal" action="<?php echo site_url() ?>tlhp/kkt/view" method="get" id="formLhp"> 
									...
									<div class="col-md-12 top-space must-center">
										<button class="btn btn-info btn-fill btn-wd bottom-space" data-bind="event: {click: openMonitoringPage}" id="btnSearch">
											<i aria-hidden="true" class="fa fa-pencil-square-o"></i> LIHAT LHP
										</button>
									</div>
								</form>
							</div>
