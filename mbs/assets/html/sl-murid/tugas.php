						...
						<table class="table table-bordered table-striped">
							...
							<tbody>
								<tr>
									...
									<td><a href="tugas_jpg.php"><i class="fa fa-user"></i> Lihat Tugas</a></td>
								</tr>
								<tr>
									<td>Pernafasan</td>
									<td>Biology</td>
									...
									<td><a href="tests.php"><i class="fa fa-user"></i> Lihat Tugas</a></td>
								</tr>
								...
								<tr>
									...
									<td><a href="tests.php"><i class="fa fa-user"></i> Lihat
											Tugas</a></td>
								</tr>
								<tr>
									<td>Pecahan</td>
