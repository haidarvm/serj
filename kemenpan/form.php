								   ...
								   <div class="row">
									...
									<div class="row">
										<div class="col-md-6">
											...
											<div class="col-md-12">
												<span>+ Tambah Tim Pemeriksa</span>
											</div>
											<div class="col-md-12">
									...
									<div class="row">
										<div class="col-md-12">
											...
											<div class="col-md-9">
												<div class="form-group">
													<label>Uraian</label>
													<textarea rows="5" class="form-control border-input">LHP Kinerja atas Penetapan Formasi PNS dan Pemberian Pendapat atas Ketersediaan Anggaran Tahun 2009 dan 2010 pada Kementerian Pendayagunaan Aparatur Negara dan Reformasi Birokrasi
													</textarea>
												</div>
											</div>
											<div class="col-md-12"></div>
